...
export {
    ...
    const statuses {
        ...
        [0x6A] = "Encapsulated CIP Services Not Allowed",
        [0xFF] = "General Error",
        } &default = function(i: count):string { return fmt("status (%d)", i); } &redef;

    ## ENIP common data format type IDs
    const cdf_types {
    ...
    const cip_classes = {
        ...
        } &default = function(i: count):string { return fmt("cip_class (%d)", i); } &redef;
    ...
    const cip_services = {
        ...
        [0xD4] = "Forward Open Reply",
        [0xD5] = "Get Instance Attribute List Reply",
        [0x7F] = "Mask",
        [0x80] = "Response Mask",
        [0x81] = "Get Attributes All Reply",
        [0x83] = "Get Attribute List Reply",
        [0x8A] = "Multiple Service Packet Reply",
        [0x8E] = "Get Attribute Single Reply",
        } &default = function(i: count):string { return fmt("cip_service (0x%x)", i); } &redef;
    }
